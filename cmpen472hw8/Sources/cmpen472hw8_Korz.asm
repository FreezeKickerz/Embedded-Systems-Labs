...
* Output:         
*                 Terminal connected over serial
*                 PORTB bit 7 to bit 4, 7-segment 
*                 PORTB bit 3 to bit 0, 7-segment 
*
***********************************************************************
...
; in MC9S12C128 chip
msg1        DC.B    '24 hour clock', $00
msg3        DC.B    'Clock stopped and Typewrite program started.', $00
